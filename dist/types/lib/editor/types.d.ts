...
export type GridEditorSelectionSource = "pointer" | "keyboard" | "api" | "history" | "external";
...
export type GridEditorHistoryMode = "record" | "ignore" | "record-preserveRedoStack" | "replace" | "clear";
...
export type GridEditorCommandType = "select" | "clearSelection" | "move" | "resize" | "add" | "delete" | "duplicate" | "copy" | "paste" | "align" | "distribute" | "tidy" | "lock" | "unlock" | "show" | "hide" | "save" | "discard" | "reset" | "undo" | "redo" | "section-row-collapse" | "section-row-expand" | "section-row-move" | "section-row-delete" | "section-row-reorder";
export type GridEditorCommandSource = "pointer" | "keyboard" | "toolbar" | "context-menu" | "api" | "persistence" | "drop" | "external" | "remote" | "system";
...
export type GridEditorBeforeCommand = (context: GridEditorBeforeCommandContext) => MaybePromise<GridEditorBeforeCommandResult | boolean | void>;
...
export type GridEditorGuideKind = "left" | "right" | "top" | "bottom" | "center-x" | "center-y" | "spacing-x" | "spacing-y";
...
export type GridEditorGuideEdgeSide = "top" | "right" | "bottom" | "left" | "center-x" | "center-y";
...
export type GridEditorSnapResolveOptions = {
    ...
    validate?: (geometry: Pick<LayoutItem, "x" | "y" | "w" | "h">, candidate: GridEditorSnapCandidate) => GridEditorBlockedReason | null | undefined;
};
...
export type GridEditorDistributionCandidate = {
    ...
    anchor?: {
        type: "selection" | "active-item" | "section-row" | "explicit";
        id?: string;
    };
    sectionId?: string;
    rowId?: string;
...
export type GridEditorMaxVisibleGuides = number | {
    drag?: number;
    resize?: number;
    drop?: number;
    keyboard?: number;
...
export type GridEditorClipboardPayload = GridEditorClipboardPayloadV1 | GridEditorClipboardPayloadV2;
...
export type GridEditorClipboardMode = "internal" | "system" | GridEditorClipboardAdapter;
...
export type GridEditorPasteStrategy = "offset" | "cursor" | "nearest-fit" | "first-fit" | "insert-top-shift";
...
export type GridEditorController = {
    ...
    restoreRollbackCheckpoint: (checkpoint: GridEditorRollbackCheckpoint, reason?: string) => void;
    ...
    beginPlacement: (input: import("./placementSession").GridEditorBeginPlacementInput) => Promise<import("./placementSession").GridEditorPlacementSessionResult>;
    updatePlacement: (input: import("./placementSession").GridEditorUpdatePlacementInput) => import("./placementSession").GridEditorPlacementSessionResult;
    commitPlacement: (input?: import("./placementSession").GridEditorCommitPlacementInput) => Promise<GridEditorCommandResult>;
    cancelPlacement: (reason?: string) => import("./placementSession").GridEditorPlacementSessionResult;
    ...
    setExternalLayouts: (layouts: LayoutsMap, breakpoint: string, reason?: string, options?: GridEditorExternalApplyOptions) => void;
    stop: () => void;
};
