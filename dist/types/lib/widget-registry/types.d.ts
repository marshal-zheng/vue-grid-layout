...
import type { DashboardEditorShellAdapterResult, DashboardEditorShellPaletteAdapter, DashboardEditorShellPreparedMutation, DashboardEditorShellWidgetAdapter, DashboardEditorShellWidgetTemplate } from "../dashboard-editor-shell";
...
export type WidgetLifecycleStatus = "stable" | "experimental" | "deprecated" | "hidden";
export type WidgetRegistryDiagnosticLevel = "info" | "warning" | "error";
export type WidgetRegistryDiagnosticCode = "widget-registry.duplicate-type" | "widget-registry.unknown-type" | "widget-registry.invalid-type" | "widget-registry.invalid-version" | "widget-registry.deprecated-type" | "widget-registry.hidden-type" | "widget-registry.invalid-template" | "widget-registry.invalid-settings" | "widget-registry.invalid-layout" | "widget-registry.unsafe-extension-key" | "widget-registry.capability-conflict" | "widget-registry.missing-data-requirement" | "widget-registry.untyped-layout-item" | "widget-registry.renderer-hint-invalid";
...
export type WidgetSettingsFieldType = "string" | "number" | "boolean" | "enum" | "color" | "text" | "json" | "object" | "array" | "ref";
export type WidgetSettingsPredicate = {
    ...
    op: "equals";
    path: string;
    value: DashboardJsonValue;
} | {
    op: "not";
    predicate: WidgetSettingsPredicate;
} | {
    op: "all";
    predicates: WidgetSettingsPredicate[];
} | {
    op: "any";
    predicates: WidgetSettingsPredicate[];
};
