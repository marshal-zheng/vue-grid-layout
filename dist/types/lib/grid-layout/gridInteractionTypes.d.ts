...
export type GridInteractionsEditor = {
    ...
    updateIntelligence: (activeId: string, activeItem: LayoutItem, candidateItem: LayoutItem, resizeHandle?: ResizeHandleAxis) => unknown;
...
export type GridInteractionModelCommitters = {
    ...
    onLayoutMaybeChanged: (newLayout: Layout, oldLayout?: Layout | null, historyMode?: "push" | "replace") => void;
};
