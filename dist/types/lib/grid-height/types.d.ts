...
export type GridHeightSource = "height-mode" | "auto-size" | "container-height" | "measured-parent" | "fallback";
export type GridRowHeightSource = "row-height" | "fit" | "mobile-row-height" | "default" | "empty-fit-fallback" | "fallback";
export type GridHeightDiagnosticLevel = "info" | "warning" | "error";
export type GridHeightDiagnosticCode = "missing-container-height" | "measurement-unavailable" | "fit-min-row-height-fallback" | "fixed-container-height-fallback" | "scroll-container-height-fallback" | "empty-fit-layout" | "invalid-height-mode" | "invalid-container-height" | "invalid-row-height" | "invalid-min-row-height" | "invalid-render-precision" | "mode-alias-conflict" | "unsupported-dashboard-field";
export declare const GRID_HEIGHT_DIAGNOSTIC_CODES: {
