# LAYOUT-layout-settings-migration-collision-repair Legacy Spec Brief
...
TARGET_SPEC: docs/specs/layout-settings-migration-collision-repair
...
- `settings-repair`: Legacy migration coverage for `layout-settings-migration-collision-repair` (Layout Settings Migration & Collision Repair 需求规格). Current initiative status: `done`. Existing requirements map to R1-R10.
...
无。Legacy migration 没有引入新的 blocking question；历史 clarification 仍保留在 `docs/specs/layout-settings-migration-collision-repair/requirements.md`。
