# EDITOR-editor-multiselect-group-move-core Legacy Spec Brief
...
TARGET_SPEC: docs/specs/editor-multiselect-group-move-core
...
- `group-move-core`: Legacy migration coverage for `editor-multiselect-group-move-core` (Editor 多选组移动核心需求规格). Current initiative status: `done`. Existing requirements map to R1-R8.
...
无。Legacy migration 没有引入新的 blocking question；历史 clarification 仍保留在 `docs/specs/editor-multiselect-group-move-core/requirements.md`。
