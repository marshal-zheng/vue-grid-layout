# CORE-lean-core-bundle-boundary Legacy Spec Brief
...
TARGET_SPEC: docs/specs/lean-core-bundle-boundary
...
- `lean-core-boundary`: Legacy migration coverage for `lean-core-bundle-boundary` (Lean Core Bundle Boundary 需求规格). Current initiative status: `done`. Existing requirements map to R1-R12.
...
无。Legacy migration 没有引入新的 blocking question；历史 clarification 仍保留在 `docs/specs/lean-core-bundle-boundary/requirements.md`。
