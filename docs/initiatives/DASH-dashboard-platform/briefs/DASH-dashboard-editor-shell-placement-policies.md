# DASH-dashboard-editor-shell-placement-policies Legacy Spec Brief
...
TARGET_SPEC: docs/specs/dashboard-editor-shell-placement-policies
...
- `placement-policies`: Legacy migration coverage for `dashboard-editor-shell-placement-policies` (Dashboard Editor Shell Widget Placement Policies 需求规格). Current initiative status: `done`. Existing requirements map to R1-R8.
...
无。Legacy migration 没有引入新的 blocking question；历史 clarification 仍保留在 `docs/specs/dashboard-editor-shell-placement-policies/requirements.md`。
