# DASH-dashboard-editor-shell-integration Legacy Spec Brief
...
TARGET_SPEC: docs/specs/dashboard-editor-shell-integration
...
- `dashboard-shell`: Legacy migration coverage for `dashboard-editor-shell-integration` (Dashboard Editor Shell Integration 需求规格). Current initiative status: `done`. Existing requirements map to R1-R14.
...
无。Legacy migration 没有引入新的 blocking question；历史 clarification 仍保留在 `docs/specs/dashboard-editor-shell-integration/requirements.md`。
