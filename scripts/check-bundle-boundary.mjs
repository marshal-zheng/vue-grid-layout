...
const forbiddenPolicies = {
  "index.mjs": [
    ...
    ["file:widget-registry", "Widget registry must not be imported by the root closure."],
  ...
  "core.mjs": [
    ...
    ["file:widget-registry", "Widget registry must not be imported by the core closure."],
  ...
  "responsive.mjs": [
    ...
    ["file:widget-registry", "Widget registry must not be imported by the responsive closure."],
  ...
  "persistence.mjs": [
    ...
    ["file:widget-registry", "Widget registry must not be imported by the persistence closure."],
  ...
  "layout-engine.mjs": [
    ...
    ["file:widget-registry", "Widget registry must not be imported by the layout-engine closure."],
