...
export type DashboardEditorShellConfirm = (
  ctx: DashboardEditorShellAdapterContext
) => MaybePromise<boolean | DashboardEditorShellAvailability | DashboardEditorShellAdapterResult>;

export type DashboardEditorShellGuard = (
  ctx: DashboardEditorShellAdapterContext
) => MaybePromise<boolean | DashboardEditorShellAvailability | DashboardEditorShellAdapterResult | void>;
...
export type DashboardEditorShellScrollAdapter = (
  ctx: DashboardEditorShellScrollContext
) => MaybePromise<DashboardEditorShellAvailability | void>;
...
export type DashboardEditorShellTransactionStage =
  | "prepare"
  | "mutate"
  | "commit"
  | "rollback"
